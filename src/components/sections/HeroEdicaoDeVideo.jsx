        ...
        <>
            ...
            <section className="mil-side-banner mil-center">
                ...
                <div className="mil-banner-title" style={{
                    ...
                    >
                        Edição de<br />
                        Vídeo Profissional<br />
                        e Motion Design
                    </h1>

                    <p className="mil-upper mil-dark mil-up" style={{ textAlign: 'center', maxWidth: '700px' }}>
                        Transforme gravações em vídeos profissionais para redes sociais. Edição rápida, estratégica e com resultados.
                    </p>
                </div>
...
export default HeroEdicaoDeVideo;
