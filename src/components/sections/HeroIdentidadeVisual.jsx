            ...
            <section className="mil-side-banner mil-center">
                ...
                <div className="mil-banner-title" style={{
                    ...
                    <p className="mil-upper mil-dark mil-up" style={{ textAlign: 'center', maxWidth: '700px' }}>
                        {viewportSize === 'mobile' ? (
                            'Sua empresa com cara de negócio sério, confiável e pronta para se destacar no mercado.'
                        ) : (
                            <>
                                Sua empresa com cara de negócio sério, confiável e<br />
                                pronta para se destacar no mercado.
                            </>
                        )}
                    </p>
                </div>
...
export default HeroIdentidadeVisual;
