...
import HeroCriacaoDeSites from "@components/sections/HeroCriacaoDeSites";
import AboutCriacaoDeSites from "@components/sections/AboutCriacaoDeSites";
...
const CriacaoDeSites = (props) => {
    ...
    return (
        ...
        >
            <Head>
                <title>Criação de Sites Institucionais e Landing Pages | BeCHANGE</title>
                <meta name="description" content="Criação de Sites Institucionais e Landing Pages para empresas e profissionais. Design profissional, responsivo e otimizado para conversão. Orçamento personalizado." />
