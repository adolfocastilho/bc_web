            ...
            <div className="proposta-page" ref={pageRef}>
                ...
                <div className="proposta-container">
                                ...
                                <table className="proposta-table">
                                    ...
                                    <tbody>
                                        <tr className="highlight-row">
                                            ...
                                            <td>Pacote completo à vista</td>
                                            <td><strong style={{ color: "var(--success)" }}>R$ 4.639,20</strong></td>
                                            <td><strong style={{ color: "var(--success)" }}>R$ 5.839,20</strong></td>
                                            <td><span className="proposta-tag proposta-tag--discount">20% ✨</span></td>
                                        </tr>
                                        <tr>
                                            <td><strong>2</strong></td>
                                            <td>Serviços separados à vista</td>
                                            <td>Sob consulta</td>
                                            <td>Sob consulta</td>
                                            <td><span className="proposta-tag proposta-tag--discount">10%</span></td>
                                        </tr>
                                        <tr>
                                            <td><strong>3</strong></td>
                                            <td>Cartão de crédito (até 5x)</td>
                                            <td>R$ 6.378,90</td>
                                            <td>R$ 8.028,90</td>
                                            <td><span className="proposta-tag proposta-tag--info">+10%</span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div className="proposta-watermark">
                        Proposta elaborada por <a href="https://www.bechange.com.br" target="_blank" rel="noopener noreferrer">BeCHANGE</a>
                    </div>
